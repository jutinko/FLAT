...
namespace FLAT
{
	...
	HilbertRtreeIndex::HilbertRtreeIndex()
	{
	...
	void HilbertRtreeIndex::buildIndex(SpatialObjectStream* input,string indexFileStem)
	{
	...
	void HilbertRtreeIndex::loadIndex(string indexFileStem)
	{
